  ...
  return (
    ...
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <p className="text-sm">Fresh groceries delivered to your doorstep. Quality you can trust.</p>
      </div>
      ...
      <div>
        ...
        <div className="flex items-center">
          <input type="email" placeholder="Enter your email" className="p-2 w-full rounded-l-md text-black" />
          <button className="bg-yellow-400 px-4 py-2 rounded-r-md">Subscribe</button>
        </div>
        <div className="flex space-x-4 mt-4">
          <FaFacebook className="cursor-pointer hover:text-yellow-400" size={24} />
          <FaInstagram className="cursor-pointer hover:text-yellow-400" size={24} />
          <FaTwitter className="cursor-pointer hover:text-yellow-400" size={24} />
          <FaLinkedin className="cursor-pointer hover:text-yellow-400" size={24} />
        </div>
      </div>
