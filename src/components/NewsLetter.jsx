...
function NewsLetter() {
  return (
    <div className="bg-emerald-600 mt-16 px-8">
      ...
      <div className="w-full max-w-[300px] relative text-white bg-emerald-800 rounded-full ">
        <input
          className="py-3 px-6 w-full rounded-full text-white "
          type="text"
          placeholder="enter you email address"
        ></input>
        <button className="bg-emerald-800 absolute top-[50%] right-2 translate-y-[-50%] py-2 px-4 rounded-full hover:bg-emerald-500">
          Sbscribe
        </button>
      </div>
    </div>
